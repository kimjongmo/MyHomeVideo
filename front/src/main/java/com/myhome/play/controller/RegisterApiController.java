...
public class RegisterApiController {
    ...
    @PostMapping("/video")
    public ResponseEntity registerVideo(@RequestBody @Valid VideoInsertRequest videoInsertRequest){
        log.info("video register data : {}",videoInsertRequest);
        return registerApiService.register(videoInsertRequest,"video");
    }

    @PostMapping("/category")
    public ResponseEntity registerCategory(@RequestBody @Valid CategoryInsertRequest categoryInsertRequest){
